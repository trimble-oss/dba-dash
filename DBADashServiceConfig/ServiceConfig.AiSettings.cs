...
public partial class ServiceConfig
{
    ...
    private TextBox txtAiOpenCodeBaseUrl;
    private TextBox txtAiOpenCodeApiKey;
    private TextBox txtAiOpenCodeModel;
    ...
    private void InitializeAiServiceControls()
    {
        ...
        cboAiProvider.Items.AddRange(new object[] { "AzureOpenAI", "Anthropic", "OpenCode" });
        ...
        pnlOpenCode = new Panel
        {
            Anchor = AnchorStyles.Top | AnchorStyles.Left,
            Location = new Point(5, 40),
            Size = new Size(panelWidth, 3 * AiRowH + 10),
            Visible = false
        };
        txtAiOpenCodeBaseUrl = AddPanelRow(pnlOpenCode, "BaseUrl:", 0);
        txtAiOpenCodeApiKey  = AddPanelRow(pnlOpenCode, "ApiKey:",  1, true);
        txtAiOpenCodeModel   = AddPanelRow(pnlOpenCode, "Model:",   2);

        grpConfig.Controls.Add(pnlAzure);
        grpConfig.Controls.Add(pnlAnthropic);
        grpConfig.Controls.Add(pnlOpenCode);
    ...
    private void UpdateProviderFieldVisibility()
    {
        ...
        pnlOpenCode.Visible  = p.Equals("OpenCode",    StringComparison.OrdinalIgnoreCase);
    }
    ...
    private void LoadAiSettings()
    {
        ...
        txtAiOpenCodeBaseUrl.Text = collectionConfig.OpenCodeBaseUrl ?? string.Empty;
        txtAiOpenCodeApiKey.Text  = collectionConfig.OpenCodeApiKeyDecrypted ?? string.Empty;
        txtAiOpenCodeModel.Text   = collectionConfig.OpenCodeModel ?? string.Empty;
    }
    ...
    private void ApplyAiSettingsToConfig()
    {
        ...
        collectionConfig.OpenCodeBaseUrl = txtAiOpenCodeBaseUrl.Text;
        collectionConfig.OpenCodeApiKey  = txtAiOpenCodeApiKey.Text;
        collectionConfig.OpenCodeModel   = txtAiOpenCodeModel.Text;
    }
}
