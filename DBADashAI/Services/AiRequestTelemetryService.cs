...
public sealed class AiRequestTelemetryService(ILogger<AiRequestTelemetryService> logger)
{
    private readonly ILogger<AiRequestTelemetryService> _logger = logger;
