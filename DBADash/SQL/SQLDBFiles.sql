...
BEGIN
	SELECT database_id,
		   ...
		   filegroup_name COLLATE DATABASE_DEFAULT AS filegroup_name,
		   physical_name COLLATE DATABASE_DEFAULT AS physical_name,
		   type,
		   size,
		   space_used,
		   max_size,
	...
	SELECT database_id,
			...
			data_space_id,
			name COLLATE DATABASE_DEFAULT AS name,
			CASE WHEN type=1 THEN 'LOG' ELSE NULL END COLLATE DATABASE_DEFAULT AS filegroup_name,
			physical_name COLLATE DATABASE_DEFAULT AS physical_name,
			type,
