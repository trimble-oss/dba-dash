...
namespace DBADash.Deadlocks
{
    ...
    public sealed class DeadlockCollectionState
    {
        ...
        /// <summary>
        /// True when this key has no stored entry - no run committed and no backfill scheduled - which is what
        /// decides whether a successful run schedules the system_health backfill.  Set by
