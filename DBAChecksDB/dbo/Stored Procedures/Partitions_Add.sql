...
EXEC dbo.DailyPartitions_Add @TableName = 'ProcStats',@DaysInFuture=@DaysInFuture
EXEC dbo.DailyPartitions_Add @TableName = 'FunctionStats',@DaysInFuture=@DaysInFuture
