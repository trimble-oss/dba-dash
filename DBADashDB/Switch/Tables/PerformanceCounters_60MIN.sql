CREATE TABLE [Switch].[PerformanceCounters_60MIN] (
    ...
    CONSTRAINT [PK_PerformanceCounters_60MIN] PRIMARY KEY CLUSTERED ([InstanceID] ASC, [CounterID] ASC, [SnapshotDate] ASC),
