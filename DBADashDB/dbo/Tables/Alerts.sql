CREATE TABLE dbo.Alerts (
    ...
    AcknowledgeDate DATETIME2(3) NULL,
    AlertLevel TINYINT NULL,
    NotificationPeriodHrs SMALLINT NULL,
    DefaultAlertLevel AS CASE WHEN message_id = 823 OR message_id = 824 OR message_id = 825 OR severity >20 THEN CONVERT(TINYINT,1) ELSE CONVERT(TINYINT,2) END,
    DefaultNotificationPeriodHrs AS CASE WHEN message_id = 823 OR message_id = 824 OR message_id = 825 OR severity >20 THEN 168 ELSE 72 END,
    ...
    CONSTRAINT CK_AlertLevel CHECK (AlertLevel = 3 OR AlertLevel = 2 OR AlertLevel = 1)
);
