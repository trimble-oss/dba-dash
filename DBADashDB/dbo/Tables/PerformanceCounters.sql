CREATE TABLE [dbo].[PerformanceCounters] (
    ...
    CONSTRAINT [PK_PerformanceCounters] PRIMARY KEY CLUSTERED ([InstanceID] ASC, [CounterID] ASC, [SnapshotDate] ASC) WITH(DATA_COMPRESSION=PAGE) ON [PS_PerformanceCounters] ([SnapshotDate]),
