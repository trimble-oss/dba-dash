...
EXEC dbo.DailyPartitions_Add @TableName = 'JobHistory',@DaysInFuture=@DaysInFuture
...
EXEC dbo.MonthlyPartitions_Add @TableName = 'JobStats_60MIN',@MonthsInFuture=@MonthsInFuture