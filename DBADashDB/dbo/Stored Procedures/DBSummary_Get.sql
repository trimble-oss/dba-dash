...
SELECT I.InstanceGroupName AS Instance, 
	...
	SUM(CASE WHEN I.EditionID=1674378470 --AzureDB or Azure Managed Instance
				AND D.compatibility_level<150 THEN 1 WHEN D.compatibility_level < TRY_CAST(I.ProductMajorVersion AS INT)*10 THEN 1 ELSE 0 END) AS [Old Compat Level],
