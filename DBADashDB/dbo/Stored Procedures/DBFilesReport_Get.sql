CREATE PROC dbo.DBFilesReport_Get(
...
EXEC sp_executesql @SQL,N'@InstanceIDs IDs READONLY, @DatabaseID INT, @Types VARCHAR(50),@DriveName NVARCHAR(256)', @InstanceIDs, @DatabaseID, @Types, @DriveName
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[DBFilesReport_Get] TO [Reports]
    AS [dbo];
