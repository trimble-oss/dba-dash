...
CREATE TABLE #Processes(
	...
	ClientApp sysname COLLATE DATABASE_DEFAULT NULL,
	ProcedureName NVARCHAR(776) COLLATE DATABASE_DEFAULT NULL,
	StatementText NVARCHAR(MAX) COLLATE DATABASE_DEFAULT NULL,
	IsolationLevel VARCHAR(50) COLLATE DATABASE_DEFAULT NULL,
	LockMode VARCHAR(20) COLLATE DATABASE_DEFAULT NULL,
	WaitResource NVARCHAR(512) COLLATE DATABASE_DEFAULT NULL,
	WaitTimeMs BIGINT NULL,
	LogUsed BIGINT NULL,
	TransactionName NVARCHAR(128) COLLATE DATABASE_DEFAULT NULL,
	Priority SMALLINT NULL,
	LastBatchStarted DATETIME2(3) NULL,
	LastBatchCompleted DATETIME2(3) NULL,
	LastTransactionStarted DATETIME2(3) NULL,
	Status VARCHAR(30) COLLATE DATABASE_DEFAULT NULL,
	TransactionCount INT NULL,
	HostPid INT NULL,
	InputBuffer NVARCHAR(MAX) COLLATE DATABASE_DEFAULT NULL,
...
CREATE TABLE #Resources(
	...
	ResourceType VARCHAR(50) COLLATE DATABASE_DEFAULT NOT NULL,
	DatabaseID INT NULL,
	ObjectName NVARCHAR(776) COLLATE DATABASE_DEFAULT NULL,
	IndexName sysname COLLATE DATABASE_DEFAULT NULL,
	LockMode VARCHAR(20) COLLATE DATABASE_DEFAULT NULL,
	OwnerModes VARCHAR(200) COLLATE DATABASE_DEFAULT NULL,
	WaiterModes VARCHAR(200) COLLATE DATABASE_DEFAULT NULL,
