...
EXEC sp_executesql @SQL,N'@InstanceID INT,@FromDate DATETIME2(2),@ToDate DATETIME2(2),@category NVARCHAR(128),@job_id UNIQUEIDENTIFIER',@InstanceID,@FromDate,@ToDate,@category,@job_id